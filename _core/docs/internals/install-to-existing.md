...
```bash
# plan 確認
DRY_RUN=1 task install:core TARGET=~/repos/synforger/my-existing-repo

# 衝突確認
find ~/repos/synforger/my-existing-repo -name '*.tmpl.orig'
...
```bash
cd ~/repos/synforger/my-existing-repo
